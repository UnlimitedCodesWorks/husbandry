...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                              <div class="chart">
                                <canvas id="pieRegister" style="height:250px"></canvas>
                              </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                              <div class="chart">
                                <canvas id="pieIdentify" style="height:250px"></canvas>
                              </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <div class="chart">
                                    <canvas class="monthOrder" style="height:450px"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(function () {
//统计用户注册 pie chart ************************************************************************
            var pieRegister = $('#pieRegister').get(0).getContext('2d');
            ...
            //统计商户认证 pie chart ********************************************
            var pieIdentify = $('#pieIdentify').get(0).getContext('2d');
